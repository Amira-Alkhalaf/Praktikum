...
public class AnswerDataSource {
    ...
    public void saveAnswer(Answer answer) throws SQLException {
        if(instance.checkIfDataExistsInDb(QuizapyContract.AnswerTable.TABLE_NAME, QuizapyContract.AnswerTable._ID, Integer.toString(answer.getId()))) {
            updateAnswer(answer);
        } else {
            addAnswer(answer);
        }
    ...
    public void deleteAnswer(final int id) throws SQLException {
        db.delete(QuizapyContract.AnswerTable.TABLE_NAME, QuizapyContract.AnswerTable._ID +" = ?", new String[]{Integer.toString(id)});
    }
    ...
    private void updateAnswer(Answer answer) throws SQLException {
        ...
        db.update(QuizapyContract.AnswerTable.TABLE_NAME, contentValues, QuizapyContract.AnswerTable._ID + " = ?", new String[]{Integer.toString(id)});
    }
